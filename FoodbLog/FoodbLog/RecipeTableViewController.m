...
- (UITableViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [cell.recipeImage sd_setImageWithURL:[NSURL URLWithString:self.recipeResultsArray[indexPath.row].imageURLString]
...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath {
    ...
    [self.delegate didSelectRecipe:self.recipeResultsArray[indexPath.row].recipeTitle
                   withIngredients:self.recipeResultsArray[indexPath.row].caption];
